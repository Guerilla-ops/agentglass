...
const MODEL_LABELS: [string, string][] = [
  ...
  // OpenAI 5.x — same specific→general order as PRICE_TABLE. Without these,
  // "gpt-5" is a substring of every 5.4 / 5.5 / 5.6 id and the donut folds
  // distinct rate tiers into one "GPT-5" slice (#248 F21 residual).
  ["gpt-5.6-luna", "GPT-5.6 Luna"], ["gpt-5.6-terra", "GPT-5.6 Terra"],
  ["gpt-5.6-sol", "GPT-5.6 Sol"], ["gpt-5.6", "GPT-5.6"],
  ["gpt-5.5-pro", "GPT-5.5 Pro"], ["gpt-5.4-pro", "GPT-5.4 Pro"], ["gpt-5.5", "GPT-5.5"],
  ["gpt-5.4-nano", "GPT-5.4 nano"], ["gpt-5.4-mini", "GPT-5.4 mini"], ["gpt-5.4", "GPT-5.4"],
  ["gpt-5.2-pro", "GPT-5.2 Pro"], ["gpt-5.3", "GPT-5.3"], ["gpt-5.2", "GPT-5.2"],
  ["gpt-5.1-codex-mini", "GPT-5.1 Codex mini"], ["gpt-5.1", "GPT-5.1"],
  ["gpt-5-pro", "GPT-5 Pro"], ["gpt-5-nano", "GPT-5 nano"], ["gpt-5-mini", "GPT-5 mini"],
  ["gpt-5", "GPT-5"],
  ["gpt-4.5", "GPT-4.5"],
